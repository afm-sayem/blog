...
Run the aurelia application and you should the contents organized in a grid.
...
In all of your views/components style file, just require the `app.scss` and you will have all the mixins and sweet things from bourbon and neat.
